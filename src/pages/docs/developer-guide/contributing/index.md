...
<!-- *   [Coding Style Guide](./code_style/) - The Enact code style explained -->
*   [Documentation Style Guide](./documentation/) - How we use jsDoc comments to document Enact
*   [Documenting Changes](./changelogs/) -  The Enact `CHANGELOG.md` guidelines
...
*   **IMPORTANT**: All pull requests must now include the following line in the pull request comments (using your full name and email
	address), which indicates your contribution complies to the ***[Enact Developer's Certificate of Origin v1.0](./dco/)***:

	`Enact-DCO-1.0-Signed-off-by: Joe Smith <joe@myco.com>`

	Below is a layman's description of the five points in the Enact DCO (be sure to read and agree to the full text [here](./dco/)):
...
*   Finally, a couple of practical matters to help our Pull Masters stay sane:
	...
	*   Ensure inline API documentation exists and is up-to-date (minimum: component summary and descriptions of all
	properties). See the [Documentation Style Guide](./documentation/) for more details.
