...
function init () {
	...
	if (args.watch) {
		...
		if (args.static !== false) {
			copyStaticDocs('node_modules/enact/', 'content/developer-guide/');
			copyStaticDocs('node_modules/enact-dev/', 'content/developer-tools/enact-dev/');
			copyStaticDocs('node_modules/eslint-config-enact/', 'content/developer-tools/eslint-config-enact/');
		}
	}
}
